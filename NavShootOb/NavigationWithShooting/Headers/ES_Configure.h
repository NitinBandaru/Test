...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "RobotSM.h"
// the name of the Init function
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "CommunicationSM.h"
// the name of the Init function
#define SERV_2_INIT InitCommunicationSM
// the name of the run function
#define SERV_2_RUN RunCommunicationSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "StartService.h"
// the name of the Init function
#define SERV_3_INIT InitializeStartService
// the name of the run function
#define SERV_3_RUN RunStartService
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "ControlService.h"
// the name of the Init function
#define SERV_4_INIT InitializeControlService
// the name of the run function
#define SERV_4_RUN RunControlService
// How big should this services Queue be?
...
#define TIMER5_RESP_FUNC PostRobotSM
#define TIMER6_RESP_FUNC PostRobotSM
#define TIMER7_RESP_FUNC PostRobotSM
#define TIMER8_RESP_FUNC PostRobotSM
#define TIMER9_RESP_FUNC PostStartService
#define TIMER10_RESP_FUNC PostControlService
#define TIMER11_RESP_FUNC PostRobotSM
#define TIMER12_RESP_FUNC PostControlService
#define TIMER13_RESP_FUNC PostControlService
#define TIMER14_RESP_FUNC PostCommunicationSM
#define TIMER15_RESP_FUNC PostCommunicationSM
...
#define QUERY_TIMER 15
#define ComInterval_TIMER 14
#define NOPULSE1_TIMER 13
#define NOPULSE2_TIMER 12
#define Navigate_TIMER 11
#define TEMP_TIMER 10
#define CHECK_TIMER 9
#define RELOAD_TIMER 8
#define FIRING_TIMER 7
#define LOADING_TIMER 6
#define BallWait_TIMER 5
